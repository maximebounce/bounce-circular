...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/bouncesports.co',
      icon: (props: any) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/bouncesports.co/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Foot() {
  return (
    <footer className="bg-bounce-200">
      <div className="mx-auto max-w-7xl overflow-hidden py-12 px-6 sm:py-8 lg:px-8">
        <nav
